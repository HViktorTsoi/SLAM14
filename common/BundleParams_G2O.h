...
struct BundleParams_G2O{
public:
    BundleParams_G2O(int argc, char** argv);
    virtual ~BundleParams_G2O(){};
...
public:
 ...
 BundleParams_G2O::BundleParams_G2O(int argc, char** argv)
 {  
    ...
    arg.param("rotation_sigma", rotation_sigma, 0.1, "Standard deviation of camera rotation "
              "perturbation.");
    arg.param("translation_sigma", translation_sigma,0.1, "translation perturbation.");
