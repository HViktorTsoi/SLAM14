...
struct BundleParams_Ceres{
public:
    BundleParams_Ceres(int argc, char** argv);
    virtual ~BundleParams_Ceres(){};
...
BundleParams_Ceres::BundleParams_Ceres(int argc, char** argv)
{
    ...
    arg.param("num_iterations", num_iterations,30, "Number of iterations.");
